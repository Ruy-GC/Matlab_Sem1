...
% Gerardo Cortés Leal | A011639946
classdef Entregable2_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function AgregarGlobuloButtonPushed(app, event)
            % Distancia Aleatoria
            ...
            a=(app.Distancia.Value/2)*-1;
            b= app.Distancia.Value/2;
            Posx = (b-a).*rand(1,1) + a;
        ...
        function SimulaciondeMovimientoButtonPushed(app, event)
        ...
        function LimpiarGlobulosButtonPushed(app, event)
            app.clearGlobulos;
        end

        % Button pushed function: EliminarGlobuloButton
        function EliminarGlobuloButtonPushed(app, event)
        ...
        function ColoresSwitchValueChanged(app, event)
            app.updateGraph;
            app.updateGlobulos;
        end
    end
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = Entregable2_exported
